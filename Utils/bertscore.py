# Modified code from lmqg/automatic_evaluation_tool/bertscore.py Github
...
class BERTScore:
    ...
    def get_score(self, hyps, refs):
        return np.array(score(hyps, refs, lang=self.language, verbose=False, batch_size=BERTSCORE_BATCH)[0].tolist())
